...
import 'display_athlete_history.dart';
...
class AthleteHistoryPage extends StatefulWidget {
  // Constructor for AthleteHistoryPage, which takes an optional key parameter and initializes the widget.
  const AthleteHistoryPage({super.key});

  // The createState method creates the mutable state for this widget, which is managed by the _AthleteHistoryPageState class.
  @override
  State<AthleteHistoryPage> createState() => _AthleteHistoryPageState();
}
...
class _AthleteHistoryPageState extends State<AthleteHistoryPage> {
  static const String title = 'Athletes'; // Change to start_lists if you want to display start lists instead of sessions
  ...
  Future<void> loadSessionFiles() async {
    final directory = Directory('athletes');
            ...
            child: ElevatedButton(
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  ...
                  builder: (context) => DisplayAthleteHistoryPage(
                    athletePath: file.path,
                    ),
                ),
              );
              },
