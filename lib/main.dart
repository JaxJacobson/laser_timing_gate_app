...
void main() {
  runApp(const MyApp());  // MyApp widget is being run as the root of the application.
}                         // Does not rebuild MyApp because 
...
class MyHomePage extends StatefulWidget {
  const MyHomePage({super.key, required this.title}); // NEED required or else title defualts to null character
